...
import AnnotationModeSelectModal from "./modals/AnnotationModeSelectModal";
...
const StructurerWorkBenchTextInput = (
  ...
  const [showAnnotationModeSelectModal, setShowAnnotationModeSelectModal] =
    useState<boolean>(false);
  return (
    <div className="flex flex-col justify-center items-center gap-3 h-screen w-500">
      {/* {showAnnotationModeSelectModal && (
        <AnnotationModeSelectModal
          setShowAnnotationModeSelectModal={setShowAnnotationModeSelectModal}
        />
      )} */}
      <button
        className="bg-blue-500 rounded-md text-white w-full transform hover:bg-blue-700 hover:scale-110"
        onClick={
          () => props.setMode(StructurerModes.annotateText)
          // () => setShowAnnotationModeSelectModal(true)
        }
      >
